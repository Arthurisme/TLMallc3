...
INSERT INTO profile VALUES ('j2ee','english','BABIES','1','1');
INSERT INTO profile VALUES ('ACID','english','LADIES','1','1');

INSERT INTO bannerdata VALUES ('HOMMES','<image src="../images/banner_fish.gif">');
INSERT INTO bannerdata VALUES ('LADIES','<image src="../images/banner_cats.gif">');
INSERT INTO bannerdata VALUES ('BABIES','<image src="../images/banner_dogs.gif">');
INSERT INTO bannerdata VALUES ('SHOES','<image src="../images/banner_reptiles.gif">');
INSERT INTO bannerdata VALUES ('BAGS','<image src="../images/banner_birds.gif">');

INSERT INTO category VALUES ('HOMMES','Hommes','<image src="../images/fish_icon.gif"><font size="5" color="blue"> Hommes</font>');
INSERT INTO category VALUES ('BABIES','Babies','<image src="../images/dogs_icon.gif"><font size="5" color="blue"> Babies</font>');
INSERT INTO category VALUES ('SHOES','Shoes','<image src="../images/reptiles_icon.gif"><font size="5" color="blue"> Shoes</font>');
INSERT INTO category VALUES ('LADIES','Ladies','<image src="../images/cats_icon.gif"><font size="5" color="blue"> Ladies</font>');
INSERT INTO category VALUES ('BAGS','Bags','<image src="../images/birds_icon.gif"><font size="5" color="blue"> Bags</font>');

INSERT INTO product VALUES ('FI-SW-01','HOMMES','Angelfish','<image src="../images/fish1.jpg">Salt Water fish from Australia');
INSERT INTO product VALUES ('FI-SW-02','HOMMES','Tiger Shark','<image src="../images/fish4.gif">Salt Water fish from Australia');
INSERT INTO product VALUES ('FI-FW-01','HOMMES', 'Koi','<image src="../images/fish3.gif">Fresh Water fish from Japan');
INSERT INTO product VALUES ('FI-FW-02','HOMMES', 'Goldfish','<image src="../images/fish2.gif">Fresh Water fish from China');
INSERT INTO product VALUES ('K9-BD-01','BABIES','Bulldog','<image src="../images/dog2.gif">Friendly dog from England');
INSERT INTO product VALUES ('K9-PO-02','BABIES','Bags','<image src="../images/dog6.gif">Cute dog from France');
INSERT INTO product VALUES ('K9-DL-01','BABIES', 'Dalmation','<image src="../images/dog5.gif">Great dog for a Fire Station');
INSERT INTO product VALUES ('K9-RT-01','BABIES', 'Golden Retriever','<image src="../images/dog1.gif">Great family dog');
INSERT INTO product VALUES ('K9-RT-02','BABIES', 'Labrador Retriever','<image src="../images/dog5.gif">Great hunting dog');
INSERT INTO product VALUES ('K9-CW-01','BABIES', 'Chihuahua','<image src="../images/dog4.gif">Great companion dog');
INSERT INTO product VALUES ('RP-SN-01','SHOES','Rattlesnake','<image src="../images/lizard3.gif">Doubles as a watch dog');
INSERT INTO product VALUES ('RP-LI-02','SHOES','Iguana','<image src="../images/lizard2.gif">Friendly green friend');
INSERT INTO product VALUES ('FL-DSH-01','LADIES','Manx','<image src="../images/cat3.gif">Great for reducing mouse populations');
INSERT INTO product VALUES ('FL-DLH-02','LADIES','Persian','<image src="../images/cat1.gif">Friendly house cat, doubles as a princess');
INSERT INTO product VALUES ('AV-CB-01','BAGS','Amazon Parrot','<image src="../images/bird4.gif">Great companion for up to 75 years');
INSERT INTO product VALUES ('AV-SB-02','BAGS','Finch','<image src="../images/bird1.gif">Great stress reliever');
